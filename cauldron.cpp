...
Cauldron::Cauldron(int64_t id, Tmpl8::vec2& pos) :
	...
	sprites_.push_back(Sprite(std::string("emptycauldron"), 2.5));
	sprites_.push_back(Sprite(std::string("filledcauldron"), 2.5));
...
void Cauldron::draw(Tmpl8::Surface* surface) {
	currentSprite_ = items_.size() != 0;
